...
const data = {
  "Normal Recyclables": [
    { name: "Office Paper (A3/A4)", price: "RS 14/kg", note: "", image: Paper },
    { name: "Newspaper", price: "RS 10/kg", note: "Market Rates Dropped Recently", image: News },
    { name: "Copies/Books", price: "RS 7/kg", note: "Market Rates Dropped Recently", image: Books },
    { name: "Cardboard", price: "RS 8/kg", note: "To get quote for bulk qty. call at +91-8595358613", image: Box },
    { name: "Plastic", price: "RS 25/kg", note: "", image: Plastic },
    { name: "Iron", price: "RS 37/kg", note: "To get quote for bulk qty. call at +91-8595358613", image: Iron },
    { name: "Steel Utensils", price: "RS 105/kg", note: "", image: Steel },
    { name: "Aluminium", price: "RS 305/kg", note: "", image: Aluminium },
    { name: "Brass", price: "RS 425/kg", note: "", image: Brass },
    { name: "Copper", price: "", note: "", image: Copper },
  ],
  "Large Appliances": [
    { name: "Split AC Copper Coil 1.5 Ton (Indoor + Outdoor)", price: "RS 4100/piece", note: "", image : Ac1 },
    { name: "Window AC 1.5 Ton (Copper Coil)", price: "RS 3000/piece", note: "", image : windowAc },
    { name: "AC 1 Ton (Copper Coil)", price: "RS 1300/piece", note: "", image : Ac1 },
    { name: "Front Load Fully Automatic Washing Machine", price: "RS 4500/piece", note: "", image : Washing },
    { name: "AC 2 Ton (Copper Coil)", price: "RS 750/piece", note: "", image : Ac1 },
    { name: "Top Load Fully Automatic Washing Machine", price: "RS 750/piece", note: "", image : Washing },
  ...
  "Small Appliances": [
    { name: "Printer/scanner/fax machine", price: "RS 20/kg", note: "", image : Printer },
    { name: "Plastic E-waste", price: "RS 15/kg", note: "", image : lamp },
    { name: "Metal E-waste", price: "RS 30/kg", note: "", image : MetalE },
    { name: "CRT TV", price: "RS 150/piece", note: "", image : tv },
    { name: "Ceiling Fan", price: "RS 40/kg", note: "", image : fan },
    { name: "Motors (Copper wiring)", price: "RS 35/kg", note: "", image : motor },
    { name: "Microwave", price: "RS 200/piece", note: "", image : Microwave },
    { name: "UPS", price: "RS 180/piece", note: "", image : Ups },
    { name: "Inverter/Stabilizer (Copper Coil)", price: "RS 42/kg", note: "", image : engine },
    { name: "Battery (used with inverters)", price: "RS 72/kg", note: "", image : battery },
  ],
  "Mobiles & Computers": [
    { name: "Scrap Laptop", price: "RS 300/piece", note: "", image : lapy },
    { name: "CRT Monitor", price: "RS 150/piece", note: "", image : comp },
    { name: "LCD Monitor", price: "RS 20/Kg", note: "", image : comp },
    { name: "Computer CPU", price: "RS 200/piece", note: "", image : comp },
  ],
  "Others": [
    { name: "Bike", price: "RS 2100/Piece", note: "", image : bike },
    { name: "Car", price: "RS 20000/piece", note: "", image : car },
  ],
};
